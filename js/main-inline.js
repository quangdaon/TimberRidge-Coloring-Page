...
$(".page-selector").change(function() {
    ...
    pageChangeWarning.appendChild(document.createTextNode('I would let you change the image, but sadly, I am only an eel... JK; unfortunately, the selector requires a Web Server environment to work.'));
    ...
    $(cancelImage).attr('src','img/emoji.png');

    $(pageChangeCancelButton).append(cancelImage);
    ...
    $(pageChangeConfirmButton).css('display','none');
